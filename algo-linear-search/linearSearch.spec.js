...
describe("tests linearSearch", () => {
  ...
  test("linearSearch('a', 'bananas'.split('')) === 1", () => {
    expect(linearSearch('a', 'bananas'.split(''))).toEqual(1);
  });

  test("linearSearch('l', 'bananas'.split('')) === undefined", () => {
    expect(linearSearch('l', 'bananas'.split(''))).toEqual(undefined);
  });
});
...
describe("tests globalLinearSearch", () => {
  ...
  test("globalLinearSearch('l', 'bananas'.split('')) === undefined", () => {
    expect(globalLinearSearch("l", "bananas".split(""))).toEqual(undefined);
  });
});
